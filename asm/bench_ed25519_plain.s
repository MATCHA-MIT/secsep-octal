...
.Lfunc_end13:
	.size	ge_p2_dbl, .Lfunc_end13-ge_p2_dbl
                                        # -- End function
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	4, 0x0                          # -- Begin function ED25519_sign
.LCPI14_0:
	.quad	2251799813685247                # 0x7ffffffffffff
	.quad	2251799813685247                # 0x7ffffffffffff
	.text
...
# %bb.0:
	...
	movabsq	$-4942790177534073029, %rsi     # imm = 0xBB67AE8584CAA73B
	movabsq	$-6534734903238641935, %rdx     # imm = 0xA54FF53A5F1D36F1
	movabsq	$-7276294671716946913, %rax     # imm = 0x9B05688C2B3E6C1F
	movabsq	$7640891576956012808, %r13      # imm = 0x6A09E667F3BCC908
	movabsq	$6620516959819538809, %rcx      # imm = 0x5BE0CD19137E2179
	movabsq	$5840696475078001361, %r15      # imm = 0x510E527FADE682D1
	movabsq	$4354685564936845355, %r12      # imm = 0x3C6EF372FE94F82B
	movabsq	$2270897969802886507, %rbp      # imm = 0x1F83D9ABFB41BD6B
	movq	%r13, 336(%rsp)
	movq	%rsi, 344(%rsp)
	movq	%r12, 352(%rsp)
	movq	%rdx, 360(%rsp)
	...
	movb	%r8b, 319(%rsp)
	movq	%r13, 336(%rsp)
	movabsq	$-4942790177534073029, %rdx     # imm = 0xBB67AE8584CAA73B
	movq	%rdx, 344(%rsp)
	movq	%r12, 352(%rsp)
	movabsq	$-6534734903238641935, %rdx     # imm = 0xA54FF53A5F1D36F1
	movq	%rdx, 360(%rsp)
...
.LBB14_19:                              # =>This Inner Loop Header: Depth=1
	movq	336(%rsp,%rdx,8), %rsi
	bswapq	%rsi
	movq	%rsi, (%rcx)
	movq	344(%rsp,%rdx,8), %rsi
	bswapq	%rsi
	movq	%rsi, 8(%rcx)
	movq	352(%rsp,%rdx,8), %rsi
	bswapq	%rsi
	movq	%rsi, 16(%rcx)
	movq	360(%rsp,%rdx,8), %rsi
	bswapq	%rsi
	movq	%rsi, 24(%rcx)
	addq	$32, %rcx
	addq	$4, %rdx
...
.LBB14_23:
	...
	movq	1040(%rsp), %rbx
	movq	%rbx, 912(%rsp)
	movups	1008(%rsp), %xmm0
	movups	1024(%rsp), %xmm1
	movaps	%xmm1, 896(%rsp)
	movaps	%xmm0, 880(%rsp)
	leaq	(%rbx,%rbx,8), %rax
	leaq	(%rbx,%rax,2), %rax
	...
	adcq	152(%rsp), %rdx                 # 8-byte Folded Reload
	addq	136(%rsp), %rax                 # 8-byte Folded Reload
	...
	addq	%rdi, %r12
	adcq	144(%rsp), %r15                 # 8-byte Folded Reload
	addq	104(%rsp), %rbp                 # 8-byte Folded Reload
	adcq	112(%rsp), %r10                 # 8-byte Folded Reload
	addq	224(%rsp), %rbp                 # 8-byte Folded Reload
	adcq	%rcx, %r10
	addq	%rdx, %rbp
	adcq	$0, %r10
	movq	%r10, %rcx
	...
	addq	%rcx, %rdi
	adcq	328(%rsp), %r11                 # 8-byte Folded Reload
	addq	104(%rsp), %r14                 # 8-byte Folded Reload
	adcq	112(%rsp), %r10                 # 8-byte Folded Reload
	movq	%r9, 560(%rsp)
	addq	144(%rsp), %r14                 # 8-byte Folded Reload
	adcq	224(%rsp), %r10                 # 8-byte Folded Reload
	movq	%r8, 568(%rsp)
	addq	%rdx, %r14
	adcq	$0, %r10
	movq	%r10, %rcx
	...
	andq	%rbp, %rax
	addq	112(%rsp), %r10                 # 8-byte Folded Reload
...
.LBB14_55:                              # =>This Inner Loop Header: Depth=1
	movq	336(%rsp,%rcx,8), %rdx
	bswapq	%rdx
	movq	%rdx, (%r14)
	movq	344(%rsp,%rcx,8), %rdx
	bswapq	%rdx
	movq	%rdx, 8(%r14)
	movq	352(%rsp,%rcx,8), %rdx
	bswapq	%rdx
	movq	%rdx, 16(%r14)
	movq	360(%rsp,%rcx,8), %rdx
	bswapq	%rdx
	movq	%rdx, 24(%r14)
	addq	$32, %r14
	addq	$4, %rcx
...
.LBB14_59:
	...
	movq	8(%rsp), %rdx                   # 8-byte Reload
	movq	%rdx, %r9
	imulq	96(%rsp), %r9                   # 8-byte Folded Reload
	addq	%r9, %rbx
	...
	addq	%rax, %rbx
	movq	56(%rsp), %rax                  # 8-byte Reload
	imulq	240(%rsp), %rax                 # 8-byte Folded Reload
	addq	%rax, %rbx
	movq	%rsi, %rax
	...
	imulq	%rdx, %rcx
	addq	%rax, %rcx
	imulq	152(%rsp), %r12                 # 8-byte Folded Reload
	addq	%r12, %rcx
	movq	8(%rsp), %r9                    # 8-byte Reload
	movq	%r9, %rax
	imulq	%rbp, %rax
	...
	addq	%rax, %rdx
	addq	$1048576, %rdx                  # imm = 0x100000
	movq	872(%rsp), %r12                 # 8-byte Reload
	...
	movq	%rsi, %rax
	shrq	$21, %rax
	addq	856(%rsp), %rax                 # 8-byte Folded Reload
	andq	$-2097152, %rsi                 # imm = 0xFFE00000
	subq	%rsi, %r8
	...
	addq	%rsi, 232(%rsp)                 # 8-byte Folded Spill
	movzbl	695(%rsp), %esi
	andl	$31, %esi
	shlq	$16, %rsi
	...
	addq	%rsi, 224(%rsp)                 # 8-byte Folded Spill
	...
	movl	700(%rsp), %esi
	shrq	$7, %rsi
	addq	%rsi, 144(%rsp)                 # 8-byte Folded Spill
	...
	subq	%rcx, %r8
	shrq	$21, %rbx
	imulq	$-683901, %rbx, %rcx            # imm = 0xFFF59083
	addq	%rsi, %rcx
	addq	%rdx, %rcx
	andq	$-2097152, %rax                 # imm = 0xFFE00000
	subq	%rax, %rcx
	movq	%rcx, 112(%rsp)                 # 8-byte Spill
	imulq	$666643, %rbx, %rax             # imm = 0xA2C13
	movq	%rbx, 56(%rsp)                  # 8-byte Spill
	imulq	$470296, %r13, %rcx             # imm = 0x72D18
	addq	%rax, %rcx
	imulq	$666643, %r13, %rax             # imm = 0xA2C13
	movq	%r8, %rdx
	imulq	$470296, %r8, %rsi              # imm = 0x72D18
	addq	%rax, %rsi
	imulq	$654183, %r8, %r8               # imm = 0x9FB67
	addq	%rcx, %r8
	imulq	$-997805, %r13, %rax            # imm = 0xFFF0C653
	imulq	$136657, %rdx, %rcx             # imm = 0x215D1
	movq	%rdx, %r15
	addq	%rax, %rcx
	movq	%rcx, 640(%rsp)                 # 8-byte Spill
	imulq	$-997805, %rbx, %rdx            # imm = 0xFFF0C653
	...
	shrq	$21, %r9
	addq	%r9, %rdx
	imulq	$136657, %r13, %r9              # imm = 0x215D1
	addq	%r9, %rdx
	imulq	$666643, %r15, %r9              # imm = 0xA2C13
	movq	%r15, %rbx
	movq	%r15, 624(%rsp)                 # 8-byte Spill
	imulq	$470296, %r11, %rbp             # imm = 0x72D18
	addq	%r9, %rbp
	imulq	$654183, %r11, %r9              # imm = 0x9FB67
	addq	%rsi, %r9
	imulq	$-997805, %r11, %rax            # imm = 0xFFF0C653
	addq	%r8, %rax
	imulq	$666643, %rdi, %rsi             # imm = 0xA2C13
	addq	%r12, %rsi
	imulq	$666643, %r11, %r8              # imm = 0xA2C13
	imulq	$470296, %rdi, %r12             # imm = 0x72D18
	addq	%r8, %r12
	imulq	$654183, %rdi, %r15             # imm = 0x9FB67
	addq	%rbp, %r15
	imulq	$-997805, %rdi, %r8             # imm = 0xFFF0C653
	addq	%r9, %r8
	imulq	$136657, %rdi, %r9              # imm = 0x215D1
	addq	%rax, %r9
	imulq	$470296, 56(%rsp), %rbp         # 8-byte Folded Reload
                                        # imm = 0x72D18
	addq	%r14, %rbp
	addq	120(%rsp), %rbp                 # 8-byte Folded Reload
	andq	$-2097152, %rcx                 # imm = 0xFFE00000
	subq	%rcx, %rbp
	imulq	$654183, %r13, %rax             # imm = 0x9FB67
	addq	%rax, %rbp
	imulq	$-997805, %rbx, %rax            # imm = 0xFFF0C653
	addq	%rax, %rbp
	imulq	$136657, %r11, %rax             # imm = 0x215D1
	addq	%rax, %rbp
	imulq	$-683901, %rdi, %rax            # imm = 0xFFF59083
	addq	%rax, %rbp
	imulq	$666643, %r10, %rcx             # imm = 0xA2C13
	addq	152(%rsp), %rcx                 # 8-byte Folded Reload
	movq	40(%rsp), %rax                  # 8-byte Reload
	andq	$-2097152, %rax                 # imm = 0xFFE00000
	subq	%rax, %rcx
	imulq	$470296, %r10, %rax             # imm = 0x72D18
	addq	%rsi, %rax
	movq	648(%rsp), %rsi                 # 8-byte Reload
	andq	$-2097152, %rsi                 # imm = 0xFFE00000
	subq	%rsi, %rax
	movq	%rax, 32(%rsp)                  # 8-byte Spill
	imulq	$654183, %r10, %rsi             # imm = 0x9FB67
	addq	%r12, %rsi
	addq	656(%rsp), %rsi                 # 8-byte Folded Reload
	movq	48(%rsp), %rax                  # 8-byte Reload
	andq	$-2097152, %rax                 # imm = 0xFFE00000
	subq	%rax, %rsi
	movq	%rsi, %r14
	movq	%rsi, 40(%rsp)                  # 8-byte Spill
	imulq	$-997805, %r10, %rbx            # imm = 0xFFF0C653
	...
	subq	%rsi, %rbx
	shrq	$21, %rax
	imulq	$136657, %r10, %r15             # imm = 0x215D1
	addq	%rax, %r15
	addq	%r8, %r15
	...
	andq	$-2097152, %rax                 # imm = 0xFFE00000
	subq	%rax, %r15
	imulq	$-683901, %r10, %r10            # imm = 0xFFF59083
	...
	addq	$1048576, %rax                  # imm = 0x100000
	movq	56(%rsp), %r8                   # 8-byte Reload
	imulq	$654183, %r8, %rbp              # imm = 0x9FB67
	addq	16(%rsp), %rbp                  # 8-byte Folded Reload
	addq	136(%rsp), %rbp                 # 8-byte Folded Reload
	movq	632(%rsp), %rcx                 # 8-byte Reload
	andq	$-2097152, %rcx                 # imm = 0xFFE00000
	subq	%rcx, %rbp
	addq	640(%rsp), %rbp                 # 8-byte Folded Reload
	imulq	$-683901, %r11, %rcx            # imm = 0xFFF59083
	addq	%rcx, %rbp
	movq	%rax, %rsi
	andq	$-2097152, %rax                 # imm = 0xFFE00000
	subq	%rax, %r9
	imulq	$-683901, 624(%rsp), %rax       # 8-byte Folded Reload
                                        # imm = 0xFFF59083
	leaq	(%rdx,%rax), %r11
	addq	%rax, %rdx
	addq	$1048576, %rdx                  # imm = 0x100000
	movq	64(%rsp), %rdi                  # 8-byte Reload
	shrq	$21, %rdi
	imulq	$136657, %r8, %rax              # imm = 0x215D1
	movq	72(%rsp), %rcx                  # 8-byte Reload
	addq	%rcx, %rax
	addq	%rdi, %rcx
	addq	$1048576, %rcx                  # imm = 0x100000
	...
	andq	$-2097152, %rcx                 # imm = 0xFFE00000
	subq	%rcx, %rax
	imulq	$-683901, %r13, %rcx            # imm = 0xFFF59083
	addq	%rcx, %rax
	movq	%rdx, %rcx
	andq	$-2097152, %rdx                 # imm = 0xFFE00000
	subq	%rdx, %r11
	...
	imulq	$666643, %r9, %rax              # imm = 0xA2C13
	addq	216(%rsp), %rax                 # 8-byte Folded Reload
	movq	8(%rsp), %rcx                   # 8-byte Reload
	andq	$-2097152, %rcx                 # imm = 0xFFE00000
	subq	%rcx, %rax
	imulq	$470296, %r9, %rcx              # imm = 0x72D18
	addq	24(%rsp), %rcx                  # 8-byte Folded Reload
	movq	48(%rsp), %rsi                  # 8-byte Reload
	movq	%rsi, 8(%rsp)                   # 8-byte Spill
	andq	$-2097152, %rsi                 # imm = 0xFFE00000
	subq	%rsi, %rcx
	imulq	$136657, %r9, %rsi              # imm = 0x215D1
	addq	16(%rsp), %rsi                  # 8-byte Folded Reload
	imulq	$-683901, %r9, %r11             # imm = 0xFFF59083
	addq	%r15, %r11
	movq	%r12, %rdi
	sarq	$21, %rdi
	addq	%rdi, %r11
	andq	$-2097152, %r14                 # imm = 0xFFE00000
	subq	%r14, %r11
	movq	%r11, 16(%rsp)                  # 8-byte Spill
	imulq	$666643, %rbx, %rdi             # imm = 0xA2C13
	addq	80(%rsp), %rdi                  # 8-byte Folded Reload
	imulq	$470296, %rbx, %r11             # imm = 0x72D18
	addq	%rax, %r11
	imulq	$654183, %rbx, %r14             # imm = 0x9FB67
	addq	%rcx, %r14
	imulq	$-683901, %rbx, %rax            # imm = 0xFFF59083
	addq	%rsi, %rax
	...
	subq	%r12, %rax
	movq	%rax, 64(%rsp)                  # 8-byte Spill
	imulq	$666643, %rbp, %rcx             # imm = 0xA2C13
	addq	88(%rsp), %rcx                  # 8-byte Folded Reload
	imulq	$470296, %rbp, %r15             # imm = 0x72D18
	addq	%rdi, %r15
	imulq	$654183, %rbp, %rdi             # imm = 0x9FB67
	addq	%r11, %rdi
	imulq	$-997805, %rbp, %rax            # imm = 0xFFF0C653
	...
	sarq	$21, %rsi
	imulq	$-683901, %rbp, %r11            # imm = 0xFFF59083
	addq	%rsi, %r11
	imulq	$-997805, %r9, %r14             # imm = 0xFFF0C653
	addq	40(%rsp), %r14                  # 8-byte Folded Reload
	imulq	$136657, %rbx, %rsi             # imm = 0x215D1
	addq	%rsi, %r14
	addq	%r11, %r14
	andq	$-2097152, %r13                 # imm = 0xFFE00000
	subq	%r13, %r14
	imulq	$666643, %rdx, %rsi             # imm = 0xA2C13
	addq	96(%rsp), %rsi                  # 8-byte Folded Reload
	imulq	$470296, %rdx, %r12             # imm = 0x72D18
	addq	%rcx, %r12
	imulq	$654183, %rdx, %r11             # imm = 0x9FB67
	addq	%r15, %r11
	imulq	$-997805, %rdx, %r13            # imm = 0xFFF0C653
	addq	%rdi, %r13
	imulq	$666643, %r10, %r15             # imm = 0xA2C13
	addq	104(%rsp), %r15                 # 8-byte Folded Reload
	imulq	$654183, %r10, %rbp             # imm = 0x9FB67
	addq	%r12, %rbp
	imulq	$136657, %r10, %r9              # imm = 0x215D1
	addq	%r13, %r9
	imulq	$136657, %rdx, %r13             # imm = 0x215D1
	addq	%rax, %r13
	imulq	$654183, %r8, %rcx              # imm = 0x9FB67
	addq	%rsi, %rcx
	imulq	$136657, %r8, %rdi              # imm = 0x215D1
	addq	%r11, %rdi
	imulq	$666643, %r8, %rsi              # imm = 0xA2C13
	...
	subq	%r12, %rax
	movq	%rax, 48(%rsp)                  # 8-byte Spill
	imulq	$470296, %r10, %r15             # imm = 0x72D18
	leaq	(%rcx,%r15), %rax
	movq	%rax, 24(%rsp)                  # 8-byte Spill
	addq	%rcx, %r15
	addq	$1048576, %r15                  # imm = 0x100000
	...
	leaq	(%r12,%rdi), %rbp
	addq	$1048576, %rbp                  # imm = 0x100000
	imulq	$-683901, %r8, %r8              # imm = 0xFFF59083
	addq	%r9, %r8
	imulq	$-683901, %r10, %rcx            # imm = 0xFFF59083
	leaq	(%rcx,%r13), %r10
	addq	%r13, %rcx
	addq	$1048576, %rcx                  # imm = 0x100000
	imulq	$654183, 72(%rsp), %rdi         # 8-byte Folded Reload
                                        # imm = 0x9FB67
	addq	32(%rsp), %rdi                  # 8-byte Folded Reload
	addq	8(%rsp), %rdi                   # 8-byte Folded Reload
	imulq	$-997805, %rbx, %r9             # imm = 0xFFF0C653
	addq	%r9, %rdi
	imulq	$136657, 136(%rsp), %r9         # 8-byte Folded Reload
                                        # imm = 0x215D1
	addq	%r9, %rdi
	movq	112(%rsp), %r9                  # 8-byte Reload
	andq	$-2097152, %r9                  # imm = 0xFFE00000
	subq	%r9, %rdi
	imulq	$-683901, %rdx, %rdx            # imm = 0xFFF59083
	addq	%rdx, %rdi
	movq	%rcx, %r9
	andq	$-2097152, %rcx                 # imm = 0xFFE00000
	subq	%rcx, %r10
	...
	sarq	$21, %r12
	imulq	$666643, %r12, %r14             # imm = 0xA2C13
	addq	48(%rsp), %r14                  # 8-byte Folded Reload
	imulq	$470296, %r12, %rax             # imm = 0x72D18
	addq	%rbx, %rax
	movq	%rdx, %rdi
	andq	$-2097152, %rdx                 # imm = 0xFFE00000
	subq	%rdx, %rax
	imulq	$654183, %r12, %rbx             # imm = 0x9FB67
	addq	24(%rsp), %rbx                  # 8-byte Folded Reload
	andq	$-2097152, %r15                 # imm = 0xFFE00000
	subq	%r15, %rbx
	sarq	$21, %rdi
	addq	%rdi, %rbx
	imulq	$-997805, %r12, %r15            # imm = 0xFFF0C653
	addq	%r13, %r15
	movq	%rsi, %rdx
	andq	$-2097152, %rsi                 # imm = 0xFFE00000
	subq	%rsi, %r15
	...
	sarq	$21, %rdx
	addq	%rdx, %rdi
	imulq	$-683901, %r12, %rsi            # imm = 0xFFF59083
	...
	imulq	$666643, %r9, %rax              # imm = 0xA2C13
	addq	%r14, %rax
	imulq	$470296, %r9, %r10              # imm = 0x72D18
	addq	%r8, %r10
	imulq	$654183, %r9, %r8               # imm = 0x9FB67
	addq	%rdx, %r8
	imulq	$-997805, %r9, %rdx             # imm = 0xFFF0C653
	addq	%rbx, %rdx
	imulq	$136657, %r9, %rbx              # imm = 0x215D1
	addq	%r15, %rbx
	andl	$2097151, %r13d                 # imm = 0x1FFFFF
	andl	$2097151, %edi                  # imm = 0x1FFFFF
	andl	$2097151, %esi                  # imm = 0x1FFFFF
	...
	movq	%r11, 16(%rsp)                  # 8-byte Spill
	andl	$2097151, %ecx                  # imm = 0x1FFFFF
	imulq	$-683901, %r9, %r15             # imm = 0xFFF59083
	addq	%r13, %r15
	movq	%rax, %r13
	sarq	$21, %r13
	addq	%r10, %r13
...
# %bb.0:
	...
	retq
.Lfunc_end16:
	.size	fe_mul_impl, .Lfunc_end16-fe_mul_impl
                                        # -- End function
...
# %bb.0:
	...
	retq
.Lfunc_end17:
	.size	fe_tobytes, .Lfunc_end17-fe_tobytes
                                        # -- End function
