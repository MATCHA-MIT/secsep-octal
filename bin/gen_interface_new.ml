...
let standalone_salsa20 : Base_func_interface.t = [
  ...
  "_start", [
    ...
    -4, [ ((SingleConst 0L, SingleConst 128L), RangeConst [(SingleConst 0L, SingleConst 128L)], SingleTop) ];
  ]
]
...
let _ (* bench_ed25519_plain *) : Base_func_interface.t = [
  "SHA512_Init", [
    r RDI, [ 
      (SingleConst 0L, SingleConst 64L), RangeConst [], SingleTop;
...
let () = 
  ...
  let stack = Stack_layout.StackLayout.from_file "./out/standalone_salsa20.stack_layout" in
  ...
  let stack = Stack_layout.StackLayout.from_file "./out/bench_sha512_plain.stack_layout" in
  ...
  let stack = Stack_layout.StackLayout.from_file "./out/bench_ed25519_plain.stack_layout" in
