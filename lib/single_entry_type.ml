...
include SingleExp
  ...
  let exe_bop_inst (is_check: bool) (isa_bop: IsaBasic.bop) (e1: t) (e2: t) (flags: flag_t): t * flag_t =
    match isa_bop with
    ...
    | Xor -> (if cmp e1 e2 = 0 then SingleConst 0L else eval (SingleBExp (SingleXor, e1, e2))) |> set_flag_helper
