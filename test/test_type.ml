...
let subtype_sol = SubType.solve_vars (SubType.remove_all_var_dummy_sub tv_rel) cond_list 4
...
let addr_base_list = InitMem.get_addr_base_range (SingleExp.SingleVarSet.of_list [ 1 ]) addr_repl_list

let _ = InitMem.pp_base_range 0 addr_base_list

let mem_key_list = InitMem.get_mem_key_list addr_base_list

let _ = InitMem.pp_mem_key 0 mem_key_list
